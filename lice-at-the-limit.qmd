...
Lice count data from Iceland (2016--2024) were available from one of the operators [@arnarlax2025].
...
With the exception of Norwegian data after 2012, histograms of louse counts show a gradual monotonic decline with heavy-tails (@fig-hist, Supplementary material figures 1--4).
...
All data are publicly available from the regulators in Canada, Ireland, Norway, and Scotland, or an operator in Iceland.
